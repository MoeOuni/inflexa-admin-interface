...
interface ScheduledTasksTableContextProps {
  featureFlags: FeatureFlagValue[];
  setFeatureFlags: React.Dispatch<React.SetStateAction<FeatureFlagValue[]>>;
}

const ScheduledTasksTableContext =
  React.createContext<ScheduledTasksTableContextProps>({
    featureFlags: [],
    setFeatureFlags: () => {},
  });

export const useScheduledTasksTable = (): ScheduledTasksTableContextProps => {
  const context = React.useContext(ScheduledTasksTableContext);
...
export function ScheduledTasksTableProvider({
  children,
  ...
  return (
    <ScheduledTasksTableContext.Provider
      value={{
        featureFlags,
        setFeatureFlags,
      }}
